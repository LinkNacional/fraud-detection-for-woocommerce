<?php
namespace Lkn\FraudDetectionForWoocommerce\PublicView;
 ...
 * @subpackage LknFraudDetectionForWoocommerce/public
 */
 ...
 */
class LknFraudDetectionForWoocommercePublic {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/lknFraudDetectionForWoocommercePublic.css', array(), $this->version, 'all' );
